...
namespace Elements.Core
{
    public struct KRectangle
    {
        ...
        public KRectangle() => (Width, Height, Transform) = (1, 1, new());

        public KRectangle(in float width, in float height) =>
            (Width, Height, Transform) = (width, height, new());

        public KRectangle(in float width, in float height, in KTransform transform) =>
